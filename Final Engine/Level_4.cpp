...
void Level_4::init()
{
	...
	collectable[0]->setPosition(glm::vec3(-6.0f, 0.5f, 20.0f));
	collectable[1]->setPosition(glm::vec3(-6.0f, 0.5f, 30.0f));
	collectable[2]->setPosition(glm::vec3(-6.0f, 0.5f, 40.0f));
	collectable[3]->setPosition(glm::vec3(-6.0f, 0.5f, 50.0f));
	collectable[4]->setPosition(glm::vec3(-6.0f, 0.5f, 60.0f));
